DESCRIPTION = "U-Boot for IGEP PROCESSOR BOARDS based on i.MX6"
#LICENSE = "GPLv2+"
...
SRCBRANCH = "isee_imx_v2017.03_4.9.11_1.0.0_ga"
...
SRC_URI = "git://git@git.isee.biz/arm-boot/u-boot-imx.git;protocol=ssh;branch=${SRCBRANCH}"
